...
if [ "$TORIZON_PURPOSE" = "devel" ]; then
    ...
    export CT_TAG_ASPDOTNET_6="rc-6.0"
    export CT_TAG_ASPDOTNET_6_DEBUG="rc-6.0"
    export CT_TAG_ASPDOTNET_8="rc-8.0"
    export CT_TAG_ASPDOTNET_8_DEBUG="rc-8.0"
    export CT_TAG_CHROMIUM="rc"
    export CT_TAG_COG="rc"
    export CT_TAG_DOTNET_6="rc-6.0"
    export CT_TAG_DOTNET_6_DEBUG="rc-6.0"
    export CT_TAG_DOTNET_6_UNO="rc-6.0"
    export CT_TAG_DOTNET_6_UNO_DEBUG="rc-6.0"
    export CT_TAG_DOTNET_8="rc-8.0"
    export CT_TAG_DOTNET_8_DEBUG="rc-8.0"
    export CT_TAG_DOTNET_8_UNO="rc-8.0"
    export CT_TAG_DOTNET_8_UNO_DEBUG="rc-8.0"
